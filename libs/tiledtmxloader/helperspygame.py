...
class SpriteLayer(object):
    ...
    def __init__(self, tile_layer_idx, resource_loader):
        ...
        self.opacity = _layer.opacity
        self.properties = _layer.properties
    ...
    def merge(layers): # -> sprite_layer
        ...
        for layer in layers:
            ...
            tile_width = tile_width if tile_width else layer.tilewidth
            tile_height = tile_height if tile_height else layer.tileheight
...
class RendererPygame(object):
    ...
    def get_screen_pos(self, layer, world_x, world_y):
